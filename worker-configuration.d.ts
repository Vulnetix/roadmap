/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0650dbc70bd194ed5795d8fba09b6a65)
// Runtime types generated with workerd@1.20250507.0 2024-03-20 nodejs_compat
export {};
declare global {
	const KV_STORE: KVNamespace;
	const SPREADSHEET_ID: string;
	const SPREADSHEET_FEATURES_RANGE: string;
	const SPREADSHEET_FEATURES_MAPPING: string;
}
